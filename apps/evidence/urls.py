...
from apps.evidence.views import (
    ...
    transfer_custody_view, accept_custody_transfer_view, reject_custody_transfer_view
)
...
urlpatterns = [
    ...
    path('<int:evidence_id>/transfer/', transfer_custody_view, name='transfer_custody'),
